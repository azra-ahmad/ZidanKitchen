        ...
        <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="bg-gradient-to-r from-orange-500 to-red-500 p-6 text-white">
                    ...
                    <p class="text-orange-100">Perbarui informasi promo di bawah ini</p>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="title" value="<?= htmlspecialchars($promo['title']) ?>" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-300 focus:border-orange-300" required>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <input type="date" name="start_date" value="<?= $promo['start_date'] ?>" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-300 focus:border-orange-300" required>
                        </div>
                        
                        <div class="space-y-2">
                            <label class="block text-gray-700 font-medium">Tanggal Berakhir <span class="text-red-500">*</span></label>
                            <input type="date" name="end_date" value="<?= $promo['end_date'] ?>" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-300 focus:border-orange-300" required>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                <input type="number" name="discount" min="0" max="100" value="<?= $promo['discount'] ?>" class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-orange-300 focus:border-orange-300" placeholder="0-100">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="bundle_price" min="0" value="<?= $promo['bundle_price'] ?>" class="w-full px-10 py-2 border rounded-lg focus:ring-2 focus:ring-orange-300 focus:border-orange-300">
                        </div>
                    </div>
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                <div class="border rounded-lg p-4 bg-gray-50">
                                    ...
                                    <img src="../assets/images/<?= htmlspecialchars($promo['image']) ?>" class="max-h-24 mx-auto rounded-lg shadow-sm">
